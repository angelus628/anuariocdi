...
//private $host = "190.90.160.74";
  private $host = "85.13.202.111";
//private $host = "localhost";

//private $user = "anuariocdior";
//private $user = "anuarioc_org";
//private $user = "anuario_admin";
  private $user = "anuarioc1_admin";

//private $pass = "Np849376";
//private $pass = "3s81<0T29b65m7t";
  private $pass = "AnuDB2468";
  ...
  public function makeConnection(){
    ...
    $this->link = @mysql_connect($this->host, $this->user, $this->pass);
      ...
      mysql_select_db('anuarioc1_nuevo', $this->link);
		...
		if ($num_rows > 0){
			...
			for ($i = 0; $i < $num_rows; $i++){
				...
				echo '<div class="accordion-container">
						<a href="#" class="accordion-titulo"><li>' . $row['organismo'] . '</li><span class="toggle-icon"></span></a>
					  	<div class="accordion-content">
					  		<ol type="disc">';

				for ($j = date('Y', strtotime('-2 years')); $j >= 2007; $j--){
					echo '<li onclick="javascript: menuRequest(' . $i . ',' . $j . ');"><a href=#step2>' . $j . '</a></li>';
				}
