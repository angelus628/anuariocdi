            ...
            <td>
                <form class="form-inline" action="" method="post">
                    <div class="form-group">
                        <label for="organismo"><strong>Organizaciones:</strong></label>
        ...
        <tr>
            <td>
                <form class="form-inline">
                    <div class="form-group">
                        <label for="observ-query"><strong>Búsqueda general:</strong></label>
                        <input class="form-control" name="obs-query" name="obs-query">
                    </div>
                    <div class="form-group">
